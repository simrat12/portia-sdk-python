...
- A `Run` is a unique instantiation of a `Plan`. The purpose of a `Run` is to capture the state of a unique plan run at every step in an auditable way.
